...
def add_BF_feature(pns_df, bank):
    ...
    pns_join1 = pd.merge(pns_df, bank_non_flagged, how='left', left_on=['BeneficiaryAccount'],
                           right_on=['Account'])
    pns_join2 = pd.merge(pns_df, bank_non_flagged, how='left', left_on=['OrderingAccount'],
                           right_on=['Account'])
